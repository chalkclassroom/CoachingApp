                    ...
                    <div>
                        <Grid container justify={"center"} direction={"column"}>
                            <Typography align={"center"} variant="subtitle1"
                                        style={{fontFamily: 'Arimo', marginTop: '50px'}}>
                                What do you notice about the average class room engagement?
                            </Typography>
                            <Typography align={"center"} variant="subtitle1"
                                        style={{fontFamily: 'Arimo', paddingTop: '0.5em', marginBottom: '100px'}}>
                                Average Level of Engagement
                                Score: {Math.round((this.props.avgRating + Number.EPSILON) * 100) / 100}
                            </Typography>
