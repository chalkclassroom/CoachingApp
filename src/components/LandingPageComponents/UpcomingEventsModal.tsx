                ...
                <Modal open={this.state.open}>
                    <div style={getModalStyle()} className={classes.paper}>
                                ...
                                <Grid container direction="row" justify="flex-start" alignItems="center">
                                    ...
                                    <Grid item xs={6}>
                                        ...
                                        <Typography className={classes.detailText}>
                                            CHALK Coaching has been shortlisted by Reimagine Education for the ICT Tools
                                            for Teaching and Learning Award.
                                            We will be presenting our work at the conference on Monday, December 9,
                                            2019.
                                        </Typography>
                                    </Grid>
                                </Grid>
                        ...
                        >
                            ...
                            <Grid item>
                                <Typography className={classes.detailText}>
                                    CHALK Coaching has been shortlisted by Reimagine Education for the ICT Tools for
