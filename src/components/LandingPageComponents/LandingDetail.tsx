                            ...
                            <Grid container direction="row" alignItems="center">
                                ...
                                <Grid item xs={1}>
                                    <Grid container direction="row" justify="flex-end" alignItems="flex-start"
                                          style={{height: '100%'}}>
                                        <img alt={this.props.iconAlt1} src={this.props.icon1} height={100} width={100}
                                ...
                                <Grid item xs={1}>
                                    <Grid container direction="row" justify="flex-end" alignContent="center"
                                          style={{height: '100%'}}>
                                        <img alt={this.props.iconAlt2} src={this.props.icon2} height={100} width={100}
                                             style={{paddingRight: 10}}/>
                                    </Grid>
                                </Grid>
                                <Grid item xs={4}>
                        ...
                        {this.props.button1 || this.props.button2 ? (
                            <Grid item style={{paddingTop: '1em'}}>
                                <Grid container direction="row" justify="flex-start" alignItems="flex-start">
                                    <Grid item xs={2}/>
                                    <Grid item xs={4}>
                                        <Fab variant="extended" onClick={this.props.onClick1}
                                    ...
                                    <Grid item xs={1}/>
                                    <Grid item xs={4}>
                                        <Fab variant="extended" onClick={this.props.onClick2}
                                             className={classes.button}>
