					...
					<Grid container direction="column">
						<Grid item>
							<Grid container direction="row" alignItems="center">
								...
								<Grid item xs={1}>
									...
									>
										<img
											alt={this.props.iconAlt1}
											src={this.props.icon1}
											height={54}
											width={54}
								...
								<Grid item xs={4}>
									<Typography className={classes.titleText}>{this.props.title1}</Typography>
								</Grid>
								<Grid item xs={1}>
									<Grid
										container
									...
									>
										<img
											alt={this.props.iconAlt2}
											src={this.props.icon2}
											height={54}
											width={54}
											style={{ paddingRight: 10 }}
										/>
								...
								<Grid item xs={4}>
									<Typography className={classes.titleText}>{this.props.title2}</Typography>
								</Grid>
								<Grid item xs={1} />
							</Grid>
						</Grid>
						<Grid item style={{ paddingTop: '1em' }}>
							<Grid container direction="row" justify="flex-start" alignItems="flex-start">
								<Grid item xs={2} />
								<Grid item xs={4}>
									<Typography className={classes.bodyText}>{this.props.text1}</Typography>
								</Grid>
								<Grid item xs={1} />
								<Grid item xs={4}>
									<Typography className={classes.bodyText}>{this.props.text2}</Typography>
								</Grid>
								<Grid item xs={1} />
							</Grid>
						</Grid>
