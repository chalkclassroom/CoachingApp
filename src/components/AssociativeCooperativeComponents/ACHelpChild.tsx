        ...
        <Table>
            ...
            <TableBody>
                ...
                <TableRow>
                    ...
                    <TableCell padding="checkbox" className={classes.example}>
                        Pretending to be a family but it’s unclear who is the parent and who is the child; no defined
                        storyline
                    </TableCell>
                    <TableCell padding="checkbox" className={classes.example}>
                    ...
                    <TableCell padding="checkbox" className={classes.example}>
                        Pretending to be a customer and server at a restaurant while using role speech (“What would you
                        like to eat?”)
                    </TableCell>
                </TableRow>
                <TableRow>
