...
function MathHelpTeacher(props: Props): React.ReactElement {
    ...
    return (
        <Table>
            <TableBody>
                <TableRow>
                    <TableCell align="center" padding="checkbox" className={classes.header}
                               style={{backgroundColor: '#9cb4d3'}}>
                        <strong>Using math vocabulary</strong>
                    </TableCell>
                    <TableCell align="center" padding="checkbox" className={classes.header}
                               style={{backgroundColor: '#b8efe0'}}>
                        <strong>Asking questions about math concepts</strong>
                    </TableCell>
                    <TableCell align="center" padding="checkbox" className={classes.header}
                               style={{backgroundColor: '#f6d7ab'}}>
                        <strong>Demonstrating math concepts</strong>
                    </TableCell>
                    <TableCell align="center" padding="checkbox" className={classes.header}
                               style={{backgroundColor: '#99d3c1'}}>
