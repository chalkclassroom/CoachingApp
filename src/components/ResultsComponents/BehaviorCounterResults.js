   ...
   console.log("percentage: " + this.props.percentage)
    ...
    <div class="behavior">
        <div class='disapprovals' style={{display: 'inline-block', marginTop:"15%", marginRight:'17%'}}>
          ...
          <div style={{width: '23vw', height: '6vh', fontSize: '1.25em', backgroundColor:'#E55529', color:"#ffffff", fontWeight:'bold'}}>{this.props.disapprovalBehaviorCount} DISAPPROVAL</div>
          <div style={{width: '23vw', height: '6vh', fontSize: '1.25em', backgroundColor: '#E99C2E', color:"#ffffff", fontWeight:'bold'}}>{this.props.redirectionsBehaviorCount} REDIRECTION</div>
        </div>
        <div class='approvals' style={{display: 'inline-block'}}>
          <div style={{width: '23vw', height: '8vh', fontSize: '1.75em', color: '#009365', display:'inline-block', textAlign:'center'}}>TOTAL BEHAVIOR APPROVALS</div>
            <div style={{width: '23vw', height: '10vh', fontSize: '4em', color: '#009365', textAlign:'center'}}> {this.props.nonspecificBehaviorCount + this.props.specificBehaviorCount}</div>
            <div style={{width: '23vw', height: '6vh', fontSize: '1.25em', backgroundColor: '#FFD300', color:"#ffffff", fontWeight:'bold'}}>{this.props.nonspecificBehaviorCount} NON SPECIFIC</div>
            <div style={{width: '23vw', height: '6vh', fontSize: '1.25em', backgroundColor: "#009365", color:"#ffffff", fontWeight:'bold'}}>{this.props.specificBehaviorCount} SPECIFIC</div>
        </div>
      </div>
    )
    }
      ...
      <Grid >
          ...
          <div class="behavior" style={{marginRight:"10%", marginLeft:"5%"}}>
            <div class='disapprovals' style={{display: 'inline-block', marginRight:"10%", marginLeft:'5%'}}>
              <div style={{width: '20vw', height: '6vh', fontSize: '1.25em', color: "#E55529", textAlign:'center'}} >BEHAVIOR DISAPPROVALS</div>
              <div style={{width: '20vw', height: '7vh', fontSize: '2em', color: "#E55529", textAlign:'center'}}> {this.props.disapprovalBehaviorCount+this.props.redirectionsBehaviorCount}
              ...
              <div style={{width: '20vw', height: '4vh', fontSize: '1em', backgroundColor: "#E55529", color:"#ffffff", fontWeight:'bold'}}>{this.props.disapprovalBehaviorCount} DISAPPROVALS
              ...
              <div style={{width: '20vw', height: '4vh', fontSize: '1em', backgroundColor: "#E99C2E", color:"#ffffff", fontWeight:'bold'}}>{this.props.redirectionsBehaviorCount} REDIRECTIONS
            ...
            <div class='approvals' style={{display: 'inline-block'}}>
              <div style={{width: '20vw', height: '6vh', fontSize: '1.25em', color:  '#009365', display:'inline-block', textAlign:'center'}}>BEHAVIOR APPROVALS</div>
                ...
                <div style={{width: '20vw', height: '4vh', fontSize: '1em', backgroundColor: '#009365', color:"#ffffff", fontWeight:'bold'}}>{this.props.specificBehaviorCount} SPECIFIC
