                            ...
                            <Table>
                                <TableHead>
                                    <TableRow>
                                        ...
                                        <TableCell className={classes.tableHeader} style={{backgroundColor: color}}
                                                   align="left">
                                            Notes
                                        </TableCell>
                                        <TableCell className={classes.tableHeader}
                                                   style={{backgroundColor: color, width: '10%'}}>
                                    ...
                                    {this.props.data.map((row, index) => (
                                        <TableRow key={index}>
                                            ...
                                            <TableCell align="left"
                                                       className={classes.tableText}>{row.content}</TableCell>
                                            <TableCell align="center" className={classes.tableText}>
                                                <Button onClick={(): void => {
                                                    this.props.addNoteToPlan(this.props.conferencePlanId, row.content)
                                                }}>
