                    ...
                    {this.state.actionPlanExists ?
                        ...
                        >
                                                                    ...
                                                                    <div style={{padding: '2em'}}>
                                                                        ...
                                                                        <ul>
                                                                            ...
                                                                            <li>
                                                                                <Typography variant="h6"
                                                                                            style={{fontFamily: 'Arimo'}}>
                                                                                    Check that your goal can be measured
                                                                                    by
                                                                                    <br/>
                                                                                    the CHALK observation tool (e.g.
                                                                                    Reduce
                                                                                    <br/>
                            ...
                            <Grid item xs={12} style={{width: "100%", paddingBottom: '0.8em'}}>
                                <Grid container direction="row" justify="space-between" style={{height: '100%'}}>
                                    <Grid item xs={12}
                                          style={{border: '2px solid #e99c2e', borderRadius: '0.5em', height: '100%'}}>
                                        <Grid container direction="column" style={{width: '100%'}}>
                                            <Grid item>
                                                <Grid container direction="row" justify="flex-start" alignItems="center"
                                                      style={{width: '100%'}}>
                                                            ...
                                                            <Grid item>
                                                                <InfoIcon style={{
                                                                    ...
                                                                    marginTop: '0.3em'
                                                                          ...
                                                                          onClick={(e): void => this.handlePopoverOpen(e, 'benefit-popover')}/>
                                                                <Popover
                                                                    id={benefitId}
                                                                    open={benefitOpen}
                                                                    anchorEl={this.state.anchorEl}
                                                                    ...
                                                                    <div style={{padding: '2em'}}>
                                                                        ...
                                                                        <ul>
                                                                            <li>
                                                                                <Typography variant="h6"
                                                                                            style={{fontFamily: 'Arimo'}}>
                                                                                    How will achieving this goal improve
                                                                                    children&apos;s
                                                                                    <br/>
                                                                                    learning?
                                                                                </Typography>
                                                                            ...
                                                                            <li>
                                                                                <Typography variant="h6"
                                                                                            style={{fontFamily: 'Arimo'}}>
                                                                                    How will achieving this goal enhance
                                                                                    the classroom
                                                                                    <br/>
                                                            ...
                                                            <Grid item>
                                                                <InfoIcon style={{
                                                                    ...
                                                                    marginTop: '0.3em'
                                                                          ...
                                                                          onClick={(e): void => this.handlePopoverOpen(e, 'action-step-popover')}/>
                                                                <Popover
                                                                    id={actionStepId}
                                                                    open={actionStepOpen}
                                                                    anchorEl={this.state.anchorEl}
                                                                    ...
                                                                    <div style={{padding: '2em'}}>
                                                                        ...
                                                                        <ul>
                                                                            <li>
                                                                                <Typography variant="h6"
                                                                                            style={{fontFamily: 'Arimo'}}>
                                                                                    Break down the goal into two or more
                                                                                    actions.
                                                                                </Typography>
                                                                            </li>
                                                                            <li>
                                                                                <Typography variant="h6"
                                                                                            style={{fontFamily: 'Arimo'}}>
                                                                                    Consider what knowledge or skills
                                                                                    will lead to
                                                                                    <br/>
                                                                                    achieving the goal.
                                                                                </Typography>
                                                                            ...
                                                                            <li>
                                                                                <Typography variant="h6"
                                                                                            style={{fontFamily: 'Arimo'}}>
                                                                                    Create at least one action step that
                                                                                    describes
                                                                                    <br/>
                                                                                    how the coach will support the
                                                                                    teacher.
                                                                                    <br/>
                                                                                    Example: modeling
                                                                                </Typography>
                                                ...
                                                <Grid container direction="row" justify="flex-start"
                                                    ...
                                                    <Grid item xs={1}>
                                                        <Button disabled={this.props.readOnly}
                                                                ...
                                                                style={{marginLeft: '0.3em', paddingBottom: '0.5em'}}>
                                                            <AddCircleIcon style={{
                                                                fill: this.props.readOnly ? "#a9a9a9" : "#0988ec",
                                                                marginRight: '0.3em',
                                                                marginTop: '0.3em'
                                                            }}/>
                                                        </Button>
                                                                    ...
                                                                    <div style={{padding: '2em'}}>
                                                                        ...
                                                                        <ul>
                                                                            ...
                                                                            <li>
                                                                                <Typography variant="h6"
                                                                                            style={{fontFamily: 'Arimo'}}>
                                                                                    Example: laminated cards for
                                                                                    small-group game,
                                                                                    <br/>
                                                                                    list of high-level questions for
                                                                                    read-aloud
                                                                                </Typography>
                                                                            </li>
                                                                        </ul>
                                                                    ...
                                                                    <div style={{padding: '2em'}}>
                                                                        ...
                                                                        <ul>
                                                                            ...
                                                                            <li>
                                                                                <Typography variant="h6"
                                                                                            style={{fontFamily: 'Arimo'}}>
                                                                                    Both the coach and teacher are
                                                                                    responsible
                                                                                    <br/>
                                                                                    for action steps.
                                                                                </Typography>
                                                                    ...
                                                                    <div style={{padding: '2em'}}>
                                                                        ...
                                                                        <ul>
                                                                            <li>
                                                                                <Typography variant="h6"
                                                                                            style={{fontFamily: 'Arimo'}}>
                                                                                    Assign a timeframe for each action
                                                                                    step that
                                                                                    <br/>
                                                                                    supports the coach and teacher in
                                                                                    achieving
                                                                                    <br/>
                                                                                    the goal.
                                                                                </Typography>
