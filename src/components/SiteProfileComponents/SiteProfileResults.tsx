              ...
              Object.keys(this.state.averages).length > 0 ? (
                ...
                >
                  ...
                  */}
                  ...
                  {this.props.observationType === 'classroomClimate' ? (<>
                    {this.state.pdf ? (
                    <ClassroomClimateBarDetails data={this.state.averages} id={"hidden"}/>
                    ) : null}
                    {!this.state.pdf ? (
                      <ClassroomClimateBarDetails data={this.state.averages} id={"actual"}/>
                    ) : null}
                  </>) : null}
                  ...
                  {this.props.observationType === 'levelOfInstruction' ? (<>
                    {this.state.pdf ? (
                    <LevelOfInstructionBarDetails data={this.state.averages} id={"hidden"}/>
                    ) : null}
                    {!this.state.pdf ? (
                      <LevelOfInstructionBarDetails data={this.state.averages} id={"actual"}/>
                    ) : null}
                  </>) : null}
                  ...
                  {this.props.observationType === 'studentEngagement' ? (<>
                    {this.state.pdf ? (
                    <StudentEngagementBarDetails data={this.state.averages} id={"hidden"}/>
                    ) : null}
                    {!this.state.pdf ? (
                      <StudentEngagementBarDetails data={this.state.averages} id={"actual"}/>
                    ) : null}
                  </>) : null}
                  ...
                  {this.state.pdf ? (
                    <TransitionAverageBarDetails data={this.state.averages} id={"hidden"} />
                  ) : (null)}
                  {!this.state.pdf ? (
                    <TransitionAverageBarDetails data={this.state.averages} id={"actual"}/>
                  ) : (null)}
                  </>) : null}
