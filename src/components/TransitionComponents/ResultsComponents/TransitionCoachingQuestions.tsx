...
import {blue, deepOrange, indigo, lightGreen, orange, red} from "@material-ui/core/colors";
    ...
    render(): React.ReactNode {
        ...
        return (
            <Grid container direction="column">
                ...
                <Grid container direction="row" justify="center" alignItems="center">
                    <Typography variant="subtitle2" style={{fontFamily: 'Arimo'}}>
                        Select a transition type to view questions that will encourage reflection about teaching
                        practices.
                    </Typography>
                </Grid>
