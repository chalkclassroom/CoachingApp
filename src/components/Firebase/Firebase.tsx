...
class Firebase {
    ...
    constructor() {
        ...
        this.db
            ...
            .catch((error: Error) =>
                console.error('Offline Not Working: ', error)
            )
        ...
        if (userInfo.user) {
            ...
            docRef.set(data).then(() => {
                docRef
                    ...
                    .set({})
                    .then(() =>
                        console.log('Practice Teacher added to new user')
                    )
                    .catch((error: Error) =>
                        console.error(
            ...
            return this.db
                ...
                .then(user => {
                    const favouriteQuestions =
                        user.data().favouriteQuestions || []
                    const newFavouriteQuestions = favouriteQuestions.includes(
                        questionId
                    )
                    ...
                    return this.db
                        ...
                        .catch((error: Error) =>
                            console.error(
                                'Error updating favourites questions list: ',
                                error
                            )
                        )
                })
                .catch((error: Error) =>
                    console.error(
                        'Error getting favourites questions list: ',
                        error
                    )
                )
        }
    ...
    setTeacherInfo = async (
        ...
        if (partnerID === 'rJxNhJmzjRZP7xg29Ko6') {
            ...
            return this.db
                ...
                .catch((error: Error) =>
                    console.error(
                        'Error occurred when writing document:',
                        error
                    )
                )
        }
    ...
    addTeacher = async (teacherInfo: TeacherInfo): Promise<string | void> => {
        ...
        return newTeacherRef
            ...
            .catch((error: Error) => {
                console.error(
                    'Error occurred when adding teacher to dB: ',
                    error
                )
                // return "";
            })
    ...
    removePartner = async (partnerID: string): Promise<void> => {
        if (partnerID === 'rJxNhJmzjRZP7xg29Ko6') {
            ...
            return this.db
                ...
                .then(() =>
                    console.log(
                        'Partner successfully removed from Partners list!'
                    )
                )
                .catch((error: Error) =>
                    console.error(
    ...
    getRecentObservations = async (): Promise<{} | void> => {
        ...
        return getRecentObservations()
            ...
            .catch((error: Error) =>
                console.error(
                    'Error occurred getting average tone rating: ',
                    error
                )
            )
    }
                ...
                .then((querySnapshot: firebase.firestore.QuerySnapshot) => {
                    querySnapshot.forEach(doc => {
                        return this.db
                            ...
                            .catch((error: Error) =>
                                console.error(
                                    'Error occurred unlocking section: ',
                                    error
                                )
                            )
                    })
    ...
    handleWatchResultsTraining = async (section: string): Promise<void> => {
        if (this.auth.currentUser) {
            return this.db
                ...
                .doc(this.auth.currentUser.uid)
                .update({
                    resultsTraining: firebase.firestore.FieldValue.arrayUnion(
                        section
                    ),
                })
                .catch((error: Error) =>
                    console.error(
                        'Error occurred recording watched video: ',
                        error
                    )
                )
        }
    ...
    fetchBehaviourTypeCount = async (
        ...
        return getBehaviourTypeCountFirebaseFunction({ sessionId: sessionId })
            .then(
                (result: {
                    data: Array<
                        Array<{ behaviorResponse: string; count: number }>
                    >
                }) => result.data[0]
            )
            .catch((error: Error) =>
                console.error(
                    'Error occurred getting behavior type count: ',
                    error
                )
            )
    }
    ...
    fetchEngagementTrend = async (
        ...
        return getEngagementTrendFirebaseFunction({ teacherId: teacherId })
            .then(
                (result: {
                    data: Array<
                        Array<{ startDate: { value: string }; average: number }>
                    >
                }) => result.data[0]
            )
            .catch((error: Error) =>
                console.error(
                    'Error occurred getting engagement trend: ',
                    error
                )
            )
    }
    ...
    fetchInstructionTypeCount = async (
        ...
        return getInstructionTypeCountFirebaseFunction({ sessionId: sessionId })
            .then(
                (result: {
                    data: Array<
                        Array<{ instructionType: string; count: number }>
                    >
                }) => result.data[0]
            )
            .catch((error: Error) =>
                console.error(
                    'Error occurred getting instruction type count: ',
                    error
                )
            )
    }
    ...
    fetchInstructionTrend = async (
        ...
        return getInstructionTrendFirebaseFunction({ teacherId: teacherId })
            ...
            .catch((error: Error) =>
                console.error(
                    'Error occurred getting instruction trend: ',
                    error
                )
            )
    }
    ...
    fetchSessionDates = async (
        ...
        return getTransitionSessionDatesFirebaseFunction({
            ...
            .then(
                (result: {
                    data: Array<
                        Array<{ id: string; sessionStart: { value: string } }>
                    >
                }) => result.data[0]
            )
            .catch((error: Error) =>
    ...
    fetchTransitionTypeSummary = async (
        ...
        return getTransitionTypeCountFirebaseFunction({ sessionId: sessionId })
            ...
            .catch((error: Error) =>
                console.error(
                    'Error occurred getting transition type summary: ',
                    error
                )
            )
    }
    ...
    fetchTransitionTrend = async (
        ...
        return getTransitionTrendFirebaseFunction({ teacherId: teacherId })
            ...
            .catch((error: Error) =>
                console.error(
                    'Error occurred getting transition trend: ',
                    error
                )
            )
    }
    ...
    fetchSeqDetails = async (
        ...
        return getSeqDetailsFirebaseFunction({ sessionId: sessionId })
            ...
            .catch((error: Error) =>
                console.error(
                    'Error occurred getting sequential details: ',
                    error
                )
            )
    }
    ...
    fetchListeningDetails = async (
        ...
        return getListeningDetailsFirebaseFunction({ sessionId: sessionId })
            ...
            .catch((error: Error) =>
                console.error(
                    'Error occurred getting listening details: ',
                    error
                )
            )
    }
    ...
    fetchChildACSummary = async (
        ...
        return getChildACSummaryFirebaseFunction({ sessionId: sessionId })
            ...
            .catch((error: Error) =>
                console.error(
                    'Error occurred getting child AC summary: ',
                    error
                )
            )
    }
    ...
    fetchChildSeqSummary = async (
        ...
        return getChildSeqSummaryFirebaseFunction({ sessionId: sessionId })
            .then(
                (result: {
                    data: Array<
                        Array<{ notSequential: number; sequential: number }>
                    >
                }) => result.data[0][0]
            )
            .catch((error: Error) =>
    ...
    fetchChildMathSummary = async (
        ...
        return getChildMathSummaryFirebaseFunction({ sessionId: sessionId })
            ...
            .catch((error: Error) =>
                console.error(
                    'Error occurred getting child math summary: ',
                    error
                )
            )
    }
    ...
    fetchTeacherACSummary = async (
        ...
        return getTeacherACSummaryFirebaseFunction({ sessionId: sessionId })
            ...
            .catch((error: Error) =>
                console.error(
                    'Error occurred getting teacher AC summary: ',
                    error
                )
            )
    }
    ...
    fetchTeacherMathSummary = async (
        ...
        return getTeacherMathSummaryFirebaseFunction({ sessionId: sessionId })
            ...
            .catch((error: Error) =>
                console.error(
                    'Error occurred getting teacher math summary: ',
                    error
                )
            )
    }
    ...
    fetchListeningSummary = async (
        ...
        return getListeningSummaryFirebaseFunction({ sessionId: sessionId })
            .then(
                (result: {
                    data: Array<
                        Array<{ listening: number; notListening: number }>
                    >
                }) => result.data[0][0]
            )
            .catch((error: Error) =>
                console.error(
                    'Error occurred getting listening summary: ',
                    error
                )
            )
    }
    ...
    fetchLiteracyDetailsFoundational = async (
        ...
        return getLiteracyDetailsFirebaseFunction({
            ...
            .catch((error: Error) =>
                console.error(
                    'Error occurred getting literacy details: ',
                    error
                )
            )
    }
    ...
    fetchChildSeqTrend = async (
        ...
        return getChildSeqTrendFirebaseFunction({ teacherId: teacherId })
            ...
            .catch((error: Error) =>
                console.error(
                    'Error occurred getting child sequential trend: ',
                    error
                )
            )
    }
    ...
    fetchChildMathTrend = async (
        ...
        return getChildMathTrendFirebaseFunction({ teacherId: teacherId })
            ...
            .catch((error: Error) =>
                console.error(
                    'Error occurred getting child math trend: ',
                    error
                )
            )
    }
    ...
    fetchTeacherACTrend = async (
        ...
        return getTeacherACTrendFirebaseFunction({ teacherId: teacherId })
            ...
            .catch((error: Error) =>
                console.error(
                    'Error occurred getting teacher AC trend: ',
                    error
                )
            )
    }
    ...
    fetchTeacherMathTrend = async (
        ...
        return getTeacherMathTrendFirebaseFunction({ teacherId: teacherId })
            ...
            .catch((error: Error) =>
                console.error(
                    'Error occurred getting teacher math trend: ',
                    error
                )
            )
    }
    ...
    createActionPlan = async (
        ...
        actionPlansRef
            .set(data)
            .then(() => {
                const actionStepsRef = actionPlansRef
    ...
    getTeacherFirstName = async (teacherId: string): Promise<string | void> => {
        return this.db
            ...
            .get()
            .then(
                (doc: firebase.firestore.DocumentData) => doc.data().firstName
            )
            .catch((error: Error) =>
                console.error('Error getting cached document:', error)
            )
    ...
    deleteEmail = async (
        ...
        if (this.auth.currentUser) {
            return this.db
                ...
                .catch((error: Error) =>
                    console.error(
                        'An error occurred when deleting the draft',
                        error
                    )
                )
        }
    ...
    removeAppointment = async (id: string): Promise<string | void> => {
        if (this.auth.currentUser) {
            return this.db
                ...
                .catch((error: Error) =>
                    console.error(
                        'Error occurred removing appointment: ',
                        error
                    )
                )
        }
