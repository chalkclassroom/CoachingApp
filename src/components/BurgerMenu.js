            ...
            >
                ...
                <List>
                    ...
                    <ListItem button onClick={() => {
                        ...
                        <ListItemText primary="My Account" onClick={()=>this.props.history.push('/Account')}/>
                    </ListItem>
                    <ListItem button onClick={() => {
                        ...
                        <ListItemText primary="Invite Teachers" onClick={()=>this.props.history.push('/Invite')}/>
                    </ListItem>
                    <ListItem button onClick={() => {
                    ...
                    <ListItem button onClick={() => {
                        ...
                        <ListItemText primary="Coaching Results" onClick={()=>this.props.history.push('/Results')}/>
                    </ListItem>
                    <ListItem button onClick={() => {
                        ...
                        <ListItemText primary="Calendar" onClick={()=>this.props.history.push('/Calendar')}/>
                    </ListItem>
                    <ListItem button onClick={() => {
                        ...
                        <ListItemText primary="App Trainings" onClick={()=>this.props.history.push('/Trainings')}/>
                    </ListItem>
                    <ListItem button onClick={() => {
                    ...
                    <ListItem button onClick={() => {
                        ...
                        <ListItemText primary="Help" onClick={()=>this.props.history.push('/help')}/>
                    </ListItem>
                </List>
            </Drawer>
        )
