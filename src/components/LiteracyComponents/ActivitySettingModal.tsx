          ...
          >
            ...
            <Grid item style={{width: '100%', paddingTop: '0.5em'}}>
              <Typography style={{fontFamily: 'Arimo'}}>
                Select {checklistType === 'ReadingTeacher' ? 'or create' : null} a label describing the type of activity that was happening for most of {checklistType === 'ReadingTeacher' ? 'text read during this observation' : 'this observation'}:
              </Typography>
            </Grid>
            <Grid item>
              <List>
