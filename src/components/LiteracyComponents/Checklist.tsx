...
class Checklist extends React.Component<Props, State> {
  ...
  handleSubmit = (checked: Array<number>): void => {
    if (
      checked.indexOf(
        Constants.Checklist.LI[this.props.checklist as ChecklistType].length + 1
      ) === 0
    ) {
    ...
    // State update split in two to achieve zoom-in effect?
                  ...
                  <Grid item>
                    ...
                    >
                      <Grid item xs={5}>
                        <Card
                          style={{
                            height: (15 * midpoint).toString() + 'vh',
                          }}
                        >
                          <List>
                            {checklist
                      ...
                      <Grid item xs={5}>
                        ...
                        >
                          <List>
                            {checklist
                              .slice(midpoint, checklist.length)
                              .map((value, index) => {
                                return (
                                  <ListItem
                                    key={index}
