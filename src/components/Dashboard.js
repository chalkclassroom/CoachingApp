...
import {Button, Card, ClickAwayListener, Grid, Typography} from "@material-ui/core";
                        ...
                        : this.props.type === "MI" ?
                            ...
                            : this.props.type === "SE" ?
                                ...
                                : this.props.type === "AC" ?
                                    ...
                                    : this.props.type === "SA" ?
                                        <SequentialActivitiesHelp open={this.state.help}
                                                                  close={this.handleClickAwayHelp}/>
                                        : this.props.type === "LI" ?
                                            <LevelOfInstructionHelp open={this.state.help}
                                                                    close={this.handleClickAwayHelp}/>
                                            : this.props.type === "LC" ?
                                                <ListeningToChildrenHelp open={this.state.help}
                                                                         close={this.handleClickAwayHelp}/>
                                                : <div/>
                ) : this.state.notes ? (
