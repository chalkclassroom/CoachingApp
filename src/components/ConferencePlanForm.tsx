                                                        ...
                                                        <Grid item>
                                                            <InfoIcon style={{
                                                                ...
                                                                marginTop: '0.3em'
                                                                      ...
                                                                      onClick={(e): void => this.handlePopoverOpen(e, 'feedback-popover')}/>
                                                            <Popover
                                                                id={feedbackId}
                                                                open={feedbackOpen}
                                                                    ...
                                                                    <ul>
                                                                        <li>
                                                                            <Typography variant="h6"
                                                                                        style={{fontFamily: 'Arimo'}}>
                                                                                Note specific examples from the
                                                                                classroom observation
                                                                                <br/>
                                                                                that validate the teacher&apos;s
                                                                                knowledge and skills.
                                                                                <br/>
                                                                                This helps the teacher reflect on how
                                                                                her practices
                                                                                <br/>
                                                                        ...
                                                                        <li>
                                                                            <Typography variant="h6"
                                                                                ...
                                                                                strengths-based feedback
                                                                                <br/>
                                                                                does not highlight a practice that the
                                                                                teacher has
                                                                                <br/>
                                                                                already mastered; rather, it draws
                                                                                attention to
                                                                                <br/>
                                                                                one strategy the teacher does well in an
                                                                                area for
                                                                                <br/>
                                                                                overall growth.
                                                                            </Typography>
                                                        ...
                                                        <Grid item>
                                                            <InfoIcon style={{
                                                                ...
                                                                marginTop: '0.3em'
                                                                      ...
                                                                      onClick={(e): void => this.handlePopoverOpen(e, 'questions-popover')}/>
                                                            <Popover
                                                                id={questionsId}
                                                                open={questionsOpen}
                                                                anchorEl={this.state.anchorEl}
                                                                ...
                                                                <div style={{padding: '2em'}}>
                                                                    ...
                                                                    <ul>
                                                                        <li>
                                                                            <Typography variant="h6"
                                                                                        style={{fontFamily: 'Arimo'}}>
                                                                                Ask questions that will help teachers
                                                                                reflect <i>and</i>
                                                                                <br/>
                                                                        ...
                                                                        <li>
                                                                            <Typography variant="h6"
                                                                                        style={{fontFamily: 'Arimo'}}>
                                                                                Create questions related to the
                                                                                observation
                                                                                <br/>
                                                                                data that will encourage teachers to
                                                                                reflect on their
                                                                                <br/>
                                                        ...
                                                        <Grid item>
                                                            <InfoIcon style={{
                                                                ...
                                                                marginTop: '0.3em'
                                                                      ...
                                                                      onClick={(e): void => this.handlePopoverOpen(e, 'notes-popover')}/>
                                                            <Popover
                                                                id={notesId}
                                                                open={notesOpen}
                                                                anchorEl={this.state.anchorEl}
                                                                ...
                                                                <div style={{padding: '2em'}}>
                                                                    ...
                                                                    <ul>
                                                                        <li>
                                                                            <Typography variant="h6"
                                                                                        style={{fontFamily: 'Arimo'}}>
                                                                                Add an observation note from the Notes
                                                                                tab.
                                                                            </Typography>
                                                                        </li>
                                                                        <Typography variant="h6" style={{
