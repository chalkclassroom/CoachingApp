        ...
        <TrainingLayout
            ...
            conceptsUrl={
                location.state.type === Constants.LiteracyTypes.FOUNDATIONAL
                    ...
                    ? 'https://firebasestorage.googleapis.com/v0/b/cqrefpwa.appspot.com/o/Book%20Reading%20Concepts_UPDATED.mp4?alt=media&token=32bf8ecd-0dc5-4080-9c76-c7385627bb72'
                    : ''
            }
            demonstrationUrl={
                location.state.type === Constants.LiteracyTypes.FOUNDATIONAL
