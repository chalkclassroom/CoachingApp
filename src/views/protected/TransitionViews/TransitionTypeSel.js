...
const styles = ({
  ...
  class TransitionTypeSel extends React.Component {
    ...
    TransitionType = props => {
      ...
      <svg width={325.361} height={532.215} {...props}>
        <g data-name="Group 17">
          ...
          onClick={() => this.handleClick()}>
            <rect
              ...
              height={136.968}
              rx={32}
              transform="translate(3.044 172.402)"
              fill="#457159"
            />
          </g>
          <path
            d="M87.29 236.771v12.859l11.857 27.13s3.617 5.627-2.211 7.436a5.521 5.521 0 0 1-5.627-3.014l-10.45-19.9s-2.412-5.828-4.22-3.818l-7.436 8.239s-2.01 4.22-2.01 15.876c0 0 .8 2.813-4.622 2.813 0 0-3.818.2-3.818-2.612v-10.647s.6-12.259 11.455-24.517v-3.618l-1.809-10.048s-2.211-2.613-3.617-.4c0 0 .4 3.014-5.828 6.23l-7.23 2.61s-4.019 1.407-4.622-.8c0 0-1.407-3.215.8-4.019l6.431-3.617s7.637-5.024 7.235-11.455c0 0 1.206-7.235 7.838-9.244a7.588 7.588 0 0 1 7.235-1l17.083 7.829s2.412 1.407 2.412 3.215v16.881s.4 3.215-1.809 3.215c0 0-3.818-1.206-3.818-2.412l-.2-12.862s-.4-1-3.215-2.813l-2.813-2.211s-3.215-2.211-2.612.8c-.006.206 5.621 8.646 5.621 13.874zm-22.106-26.329a7.436 7.436 0 0 1 0-14.871 7.3 7.3 0 0 1 7.44 7.436 7.3 7.3 0 0 1-7.44 7.435z"
            fill="#fff"
          />
          <text
            data-name="Traveling outside classroom"
            transform="translate(70.31 323.414)"
            fill="#454545"
            fontSize={13}
            ...
            <g data-name="Group 18">
              <g data-name="Group 14">
                <rect
                  ...
                  rx={32}
                  fill="#0087b9"
                  transform="translate(188.394 171.721)"
                />
              </g>
              <text
                data-name="Behavior Management Disruption"
                transform="translate(256.757 323.414)"
                fill="#454545"
                fontSize={13}
                fontFamily="HelveticaNeue, Helvetica Neue"
              >
              ...
              <g
                data-name="Group 10"
                transform="translate(214.288 195.103)"
                fill="#fff"
              >
                <path
                  data-name="Path 57"
              ...
              <path
                data-name="Path 58"
                d="M288.248 243.277h-23.467l-11.76 20.338 11.76 20.338h23.467l11.76-20.338z"
                fill="none"
                stroke="#fff"
                strokeMiterlimit={10}
                strokeWidth={3}
              />
              <text
                transform="translate(263.308 266.352)"
                fill="#fff"
                fontSize={10}
            ...
            <g data-name="Group 19">
              <g data-name="Group 15">
                <rect
                  ...
                  height={136.968}
                  rx={32}
                  transform="translate(3.044 359.114)"
                  fill="#b25660"
                />
              </g>
              <text
                data-name="Children waiting on teacher/materials"
                transform="translate(70.584 514.215)"
                fill="#454545"
                fontSize={13}
                fontFamily="HelveticaNeue, Helvetica Neue"
              >
          ...
          <g>
            ...
            <text
              ...
              transform="translate(258.297 153.056)"
              fill="#454545"
              fontSize={13}
              fontFamily="HelveticaNeue, Helvetica Neue"
            >
          ...
          <g>
            ...
            <text
              ...
              transform="translate(70 153.056)"
              fill="#454545"
              fontSize={13}
              fontFamily="HelveticaNeue, Helvetica Neue"
            >
