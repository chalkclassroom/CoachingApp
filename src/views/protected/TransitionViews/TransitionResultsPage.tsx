...
import TransitionCoachingQuestions
    from "../../../components/TransitionComponents/ResultsComponents/TransitionCoachingQuestions"
                            ...
                            <Grid container justify={"center"} direction={"column"}>
                                <Grid item style={{padding: '1em'}}>
                                    <Typography variant="h5" style={{textAlign: "center", fontFamily: 'Arimo'}}>
                                        Total Session
                                        Time: {Math.floor((this.state.sessionTotal / 1000) / 60)}m {Math.round((((this.state.sessionTotal / 1000) / 60) % 1) * 60)}s
                                    </Typography>
                                </Grid>
                            ...
                            <div>
                                <Grid container justify={"center"} direction={"column"}>
                                    <Grid item style={{padding: '1em'}}>
                                        <Typography variant="h5" style={{textAlign: "center", fontFamily: 'Arimo'}}>
                                            Total Transition
                                            Time: {Math.floor((this.state.transitionTime / 1000) / 60)}m {Math.round((((this.state.transitionTime / 1000) / 60) % 1) * 60)}s
                                        </Typography>
                                    </Grid>
                                    <Grid container justify={"center"} direction={"column"}>
                                        <Typography align="left" variant="subtitle1"
