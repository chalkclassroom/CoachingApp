...
class MathInstructionTrainingPage extends React.Component {
  constructor(props) {
    super(props);
          ...
          >
            <Grid container item xs={3}>
              <List className={classes.buttonsList}>
                <ListItem style={{ display: "flex", justifyContent: "center" }}>
                  <img src={MathIconImage} width={"100vw"} />
                </ListItem>
                <ListItem>
                  <Button
                    size="large"
            ...
            >
              <Typography
                ...
                justify={"center"}
              >
                Training: Math Instruction Tool
              </Typography>
              <Grid item xs={12}>
                <div>
                  {this.state.view === ViewEnum.CONCEPTS ? (
...
MathInstructionTrainingPage.propTypes = {
  classes: PropTypes.object.isRequired
};

export default withStyles(styles)(
  MathInstructionTrainingPage
);
