...
class MathInstructionRecs extends React.Component {
  state = {
    open: true
  };
                  ...
                  >
                    <Typography align="center" variant="h5" gutterBottom>
                      <strong>
                        ...
                        <br />
                        MathInstruction Learning Interactions:
                      </strong>
                      <br />
                    </Typography>
                  </Grid>
...
MathInstructionRecs.propTypes = {
  classes: PropTypes.object.isRequired
};

export default withStyles(styles)(MathInstructionRecs);
