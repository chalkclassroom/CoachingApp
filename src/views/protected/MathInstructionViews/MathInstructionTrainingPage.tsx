      ...
      <div className={classes.root}>
        ...
        <div className={classes.main}>
          ...
          <div className={classes.trainingContentCard}>
            {view === ViewEnum.CONCEPTS ? 
              <TrainingVideo
                videoUrl={'https://firebasestorage.googleapis.com/v0/b/cqrefpwa.appspot.com/o/MathInstruction_Concepts.mp4?alt=media&token=5294431b-208d-41ae-a61d-f9be8e043720'} />
