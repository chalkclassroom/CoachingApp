        ...
        <div className={classes.main}>
          <div className={classes.dashboardContainer}>
            <TrainingDashboard
              ...
              buttonColor={Constants.ClimateColor}
            />
          </div>
          <div className={classes.trainingContentCard}>
            {view === ViewEnum.CONCEPTS ? 
              <TrainingVideo
                videoUrl={'https://firebasestorage.googleapis.com/v0/b/cqrefpwa.appspot.com/o/CC%20Concepts%207-17-19.mp4?alt=media&token=2375a7d2-3c6e-4eec-a9c0-a29214db9cdf'} />
