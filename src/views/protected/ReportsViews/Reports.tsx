                    ...
                    <Grid container justifyContent="space-evenly">
                        ...
                        <Card className={classes.card}>
                            <CardContent style={{padding: '1em 0 1em 0'}}>
                                ...
                                >
                                <Grid item xs={12}>
                                <Typography variant="subtitle2" style={{margin: '0 .4em 0 .4em'}}>
                                    The Teacher Profile shows average teacher practice over time.<br/><br/>
                                </Typography>
                                </Grid>
                                <Grid item xs={12}>
                        ...
                        <Card
                            ...
                            <CardContent style={{padding: '1em 0 1em 0'}}>
                                ...
                                <Grid item xs={12}>
                                <Typography variant="subtitle2" style={{margin: '0 .4em 0 .4em'}}>
                                    The Site Profile Shows average practice of all teachers at one site within a selected timeframe.<br/>
                                </Typography>
                                </Grid>
                                <Grid item xs={12}>
                                <Typography variant="subtitle1" style={{margin: '0'}}>
                    ...
                    <Grid container justifyContent="space-evenly">
                        ...
                        <Grid item xs={5}>
                            ...
                            <CardContent style={{padding: '1em 0 1em 0'}}>
                                ...
                                <Grid item xs={12}>
                                <Typography variant="subtitle2" style={{margin: '0 .4em 0 .4em'}}>
                                    The Program Profile shows average practice of all sites from one program within a selected timeframe.<br/><br/>
                                </Typography>
                                </Grid>
                                <Grid item xs={12}>
                                <Typography variant="subtitle1" style={{margin: '0'}}>
...
export default withStyles(styles)(connect(mapStateToProps, {getCoach: coachLoaded})(Reports));
