...
class AssociativeCooperativeRecs extends React.Component {
  state = {
    open: true
  };
...
AssociativeCooperativeRecs.propTypes = {
  classes: PropTypes.object.isRequired
};

export default withStyles(styles)(AssociativeCooperativeRecs);
