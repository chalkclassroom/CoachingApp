      ...
      <div className={classes.root}>
        ...
        <div className={classes.main}>
          ...
          <div className={classes.trainingContentCard}>
            {view === ViewEnum.CONCEPTS ? 
              <TrainingVideo
                videoUrl={'https://firebasestorage.googleapis.com/v0/b/cqrefpwa.appspot.com/o/AC_Concepts.mp4?alt=media&token=6499ec3f-8f39-4334-aeea-8e34a4e8fb7e'} />
            ...
            : view === ViewEnum.KNOWLEDGECHECK ? (
              <TrainingQuestionnaire section={'assoccoop'}/>
            ) : null}
          </div>
        </div>
      </div>
