...
import { ReactComponent as GenerateReportImage } from "../../../assets/images/GenerateReportImage.svg";
                    ...
                    <Grid container spacing={0} justify="center" direction={"row"} alignItems={"center"}>
                        <Grid container item xs={3}>
                            <List className={classes.buttonsList}>
                                <ListItem>
                                    <img src={SequentialIconImage} style={{width:"15vw", height:"10vh", position:"center"}} />
                                </ListItem>
                                <ListItem>
                                    <TextField
                                        select
