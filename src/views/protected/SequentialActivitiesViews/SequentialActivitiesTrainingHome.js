...
class SequentialActivitiesTrainingHome extends React.Component {
  constructor(props) {
    super(props);
...
SequentialActivitiesTrainingHome.propTypes = {
  classes: PropTypes.object.isRequired
};

export default withStyles(styles)(SequentialActivitiesTrainingHome);
