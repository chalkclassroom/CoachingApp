      ...
      <div className={classes.root}>
        <FirebaseContext.Consumer>
          {(firebase: Firebase): React.ReactNode => (
            <AppBar firebase={firebase} noBack={true} />
          )}
        </FirebaseContext.Consumer>
        {coachName ? (
          <Grid
              ...
              >
                <Grid item>
                  <Typography
                    variant="h3"
                    align={'center'}
                    style={{ fontFamily: 'Arimo', verticalAlign: 'center' }}
                  >
                    Welcome, {coachName}!
                  </Typography>
                </Grid>
                ...
                <Card className={classes.card}>
                  <CardContent>
                    <Grid
                      ...
                      justify="flex-start"
                      onClick={(): void =>
                        this.props.history.push('/LeadersUsers')
                      }
                    >
                      <Grid item>
                        <img
...
export default withStyles(styles)(
  connect(mapStateToProps, { getCoach: coachLoaded })(LeadersDashboard)
)
