...
import {ClickAwayListener, Fab, Grid, TextField, Typography, withStyles} from "@material-ui/core";
                ...
                <div className={classes.root}>
                    ...
                    <Grid container direction="column" justify="center" alignItems="center">
                        <Grid container direction="row" justify="center" alignItems="center"
                            ...
                            <img src={CoachLandingImage} alt="Coach and Teacher" width="100%"
                                 style={{postion: 'relative'}} className={classes.rootImage}/>
                            <img src={CoachLandingLargeImage} alt="Coach and Teacher" width="100%"
                                 style={{postion: 'relative'}} className={classes.largeImage}/>
                                    ...
                                    <Grid xs={5}>
                                        <Grid container direction="column" justify="center" alignItems="center"
                                            ...
                                            <Grid item style={{paddingTop: '4vh'}}>
                                                <Fab onClick={this.handleDemoButton} variant="extended"
                        ...
                        <Grid container direction="column" justify="center" alignItems="center"
                            ...
                            <Grid item
                                  style={{paddingRight: '3em', paddingBottom: '3em', paddingTop: '2em', width: "90%"}}>
                                <Impact
                                    icon={SchoolImage}
                                    color='#094492'
                                    title="IMPACT"
                                ...
                                <Impact
                                    ...
                                    text={<div>
                                        ...
                                        <ul>
                                            ...
                                            <li>Accelerates professional growth through teacher-created action plans
                                            </li>
                                        </ul>
                                    </div>}
                                />
                        ...
                        <Grid container direction="row" justify="center" alignItems="stretch"
                              style={{backgroundColor: '#459aeb'}} className={classes.section}>
                        ...
                        <Grid container direction="column" justify="center" alignItems="center"
                              className={classes.section} style={{backgroundColor: '#dbebfb'}}>
                            ...
                            <Grid item>
                                <Grid container direction="row" justify="center" alignItems="center">
                                    <img src={CoachingCycleFullImage} alt="Coaching Cycle" width="90%"
                      ...
                      across hundreds of observations in early childhood classrooms."
                        ...
                        <Grid container direction="column" justify="center" alignItems="center"
                              style={{paddingTop: '2em'}} className={classes.section}>
                            <Grid item style={{width: '100%'}}>
                                <Grid container direction="row" justify="flex-start" alignItems="center">
                            ...
                            <Grid item style={{width: '97%'}}>
                                <Grid container direction="row" justify="space-around" alignItems="center">
                                    <Grid item>
                                        <img src={MNPSLogoImage} alt="Metro Nashville Public Schools"
                                    ...
                                    <Grid item>
                                        <img src={PreschoolPromiseLogoImage} alt="Preschool Promise"
                                             className={classes.partnerLogo}/>
                                    </Grid>
                                    <Grid item>
                                    ...
                                    <Grid item>
                                        <img src={VanderbiltPeabodyLogoImage} alt="Vanderbilt Peabody College"
                                             className={classes.partnerLogo}/>
                                    </Grid>
                                    <Grid item>
                                        <img src={UDaytonLogoImage} alt="University of Dayton"
                                             className={classes.partnerLogo}/>
                                    </Grid>
                                </Grid>
                            </Grid>
                ...
                <div className={classes.mobileRoot}>
                    ...
                    <Grid container direction="column" justify="center" alignItems="center">
                        ...
                        <Grid container direction="column" justify="center" alignItems="center"
                            ...
                            <Grid item>
                                <Grid container direction="row" justify="center" alignItems="center">
                                    <img src={CoachingCycleFullMobileImage} alt="Coaching Cycle" width="90%"
                                         style={{paddingBottom: 20}}/>
                                </Grid>
                            </Grid>
                        </Grid>
