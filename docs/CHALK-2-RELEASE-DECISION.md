...
- Action plan draft contract fix plus live conference-plan list/editing for existing plans.
...
- Conference plan creation from the observation context; existing conference plans can be listed and edited in V2.
