...
function main() {
  ...
  assertIncludes(resultsPath, resultsPage, 'const notes = observation ? observation.notes || [] : []')
  assertIncludes(resultsPath, resultsPage, 'this.renderNotes(notes)')
  assertIncludes(resultsPath, resultsPage, 'analysis.executiveSummary')
  assertIncludes(resultsPath, resultsPage, 'Signals:')
  assertIncludes(resultsPath, resultsPage, 'open-observation-notes-toggle')
  assertIncludes(resultsPath, resultsPage, 'open-observation-notes-download')
  assertIncludes(resultsPath, resultsPage, 'open-observation-notes-section')
  assertIncludes(resultsPath, resultsPage, 'downloadNotes')
  assertIncludes(resultsPath, resultsPage, 'new Blob')
  assertIncludes(resultsPath, resultsPage, 'Show notes')
  assertIncludes(resultsPath, resultsPage, 'Hide notes')
  assertIncludes(resultsPath, resultsPage, 'Download notes')
  assertNotIncludes(resultsPath, resultsPage, 'open-observation-analysis-confidence')
  assertNotIncludes(resultsPath, resultsPage, "confidence + ' confidence'")
  assertNotIncludes(resultsPath, resultsPage, 'confidenceColor')
  assertNotIncludes(resultsPath, resultsPage, 'confidenceChip')
