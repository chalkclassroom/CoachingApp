...
exports.funcLiteracySummaryWriting = functions.https.onCall(async (data, context) => {
    ...
    const sqlQuery = `SELECT
                      ...
                      FROM ${functions.config().env.bq_project}.${functions.config().env.bq_dataset}.literacy${tableType}
                      WHERE id = @id`;
