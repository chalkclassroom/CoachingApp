 ...
 */
exports.funcLiteracyTrendWriting = functions.https.onCall(async(data, context) => {
    ...
    const sqlQuery = `SELECT FORMAT_TIMESTAMP('%m/%d/%Y', DATE(sessionStart)) AS startDate,
                    ...
                    FROM ${process.env.BQ_PROJECT_ID}.${process.env.BQ_DATASET}.literacyWriting${data.who}
